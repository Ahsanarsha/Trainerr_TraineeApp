...
import 'dart:async';
import 'package:trainerr_trainee_app/widgets/custom_circular_progress_indicator.dart';
...
class Utils {
  ...
  Utils.of(BuildContext _context) {
    context = _context;
  }
  ...
  static getFailedSnackBar({String message = constants.somethingWentWrong}) {
    return Get.snackbar(
      constants.failed,
      message,
